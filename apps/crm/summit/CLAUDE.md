# Summit CRM — AI assistant context

> Read this before editing. It describes **this app specifically**.

## What this app is

The CRM that closes — a sales CRM with pipeline kanban, forecasting, leaderboard and AI deal insight.

- **Core entities** (`schemas.py`): `Account`, `Contact`, `Lead`, `Deal`, `Activity`
- **Services on** (`config.py`): `email`, `slack`, `ai`, `workflows`
- **Runs at** `http://localhost:5669` after `./run.sh`
