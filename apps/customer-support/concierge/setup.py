...
POLICIES = [
    ...
    PolicyDef(role="tenant_admin", default_access="none", rules=[
        PolicyRule(entity="article", can_read=True, can_create=True, can_update=True, can_delete=True),
        PolicyRule(entity="macro", can_read=True, can_create=True, can_update=True, can_delete=True),
        PolicyRule(entity="message", can_read=True, can_create=True, can_update=True),
