...
POLICIES = [
    ...
    PolicyDef(role="tenant_admin", default_access="none", rules=[
        PolicyRule(entity="customer", can_read=True, can_create=True, can_update=True),
        PolicyRule(entity="expense", can_read=True, can_create=True, can_update=True),
        PolicyRule(entity="invoice", can_read=True, can_create=True, can_update=True),
        PolicyRule(entity="plan", can_read=True, can_create=True, can_update=True),
    ]),
