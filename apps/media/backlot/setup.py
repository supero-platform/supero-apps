...
POLICIES = [
    ...
    PolicyDef(role="tenant_admin", default_access="none", rules=[
        ...
        PolicyRule(entity="person", can_read=True, can_create=True, can_update=True, can_delete=True),
        PolicyRule(entity="production", can_read=True, can_create=True, can_update=True, can_delete=True),
        PolicyRule(entity="scene", can_read=True, can_create=True, can_update=True),
        PolicyRule(entity="shoot_location", can_read=True, can_create=True, can_update=True, can_delete=True),
    ]),
