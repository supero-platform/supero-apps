# Haven — AI assistant context

> Read this before editing. It describes **this app specifically**.

## What this app is

A premium real-estate marketplace and agent platform — find your place, tour homes, and make offers.

- **Core entities** (`schemas.py`): `Listing`, `Agent`, `Tour`, `Offer`
- **Services on** (`config.py`): `email`, `sms`, `slack`, `workflows`
- **Runs at** `http://localhost:5675` after `./run.sh`
